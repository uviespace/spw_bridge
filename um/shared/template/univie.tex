...
\newcommand{\BgThispage}{%
	\AddToHookNext{shipout/background}{%
		\put(1in,-1in){%
			...
			\node[rotate=0, scale=1, opacity=1, anchor=center, inner sep=0pt]
				at (current page.north) [below]
				{%
...
% def \preparedby, \checkedby, \approvedby, \authorisedby, \documentid, \docdatever, \doctitle
\def\approvalpage{
	\clearpage
	\pagestyle{empty}
	\null
	...
	%Copyright \copyright \the\year\ University of Vienna \par
	%This document contains proprietary information and may not be shared with
